...
function addtask(){
    ...
    document.getElementById("d2").innerHTML +=  "<div class = task><div class=topic><div>"+task+"</div><div><button type=button onclick=addtoList("+count+")>+</button></div></div><div class=todo id=todo"+count+"></div></div>";
    count++;
}
var cnt=0;
function check(a){
